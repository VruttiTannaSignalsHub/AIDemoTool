...
class LoginApp(HydraHeadApp):
    ...
    def run(self) -> None:
        ...
        st.markdown("<h1 style='text-align: center;'>Input your credentials</h1>", unsafe_allow_html=True)
    ...
    def _check_login(self, login_data) -> int:
        ...
        if login_data['username'] == 'signalshub' and login_data['password'] == '12345':
            return 1
        else:
            return 0